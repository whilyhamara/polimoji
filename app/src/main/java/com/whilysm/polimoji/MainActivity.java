...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String FILE_PROVIDER_AUTHORITY = "com.whilysm.fileprovider";
...
//            Toast.makeText(this, "Belum ada permission di emojify", Toast.LENGTH_SHORT).show();
            launchCamera();
        }
    }
...
// If you get permission, launch the camera
                    Toast.makeText(this, "Sudah ada permission ke kamera dan write external storage",
                            Toast.LENGTH_SHORT).show();
                    launchCamera();
                } else {
// If you do not get permission, show a Toast
                    Toast.makeText(this, "Permission Denied di oRPS", Toast.LENGTH_SHORT).show();
                }
                break;
            }
        }
